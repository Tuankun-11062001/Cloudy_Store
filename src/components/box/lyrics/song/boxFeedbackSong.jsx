...
const BoxFeedbackSong = ({ data }) => {
  ...
  const renderFeedbackList = (translateList) => {
    return translateList.length > 0 ? (
                ...
                <>
                  ...
                  <div className="info_other_delete">
                    ...
                    <div className="box_ask">
                      ...
                      <div>
                        <p onClick={handleDeleteTranslsate}>No</p>
                        <p onClick={(e) => handleYes(e, item._id)}>Yes</p>
                      </div>
                    </div>
                  </div>
                </>
      ...
      <p>No translations available for this language.</p> // Thông báo khi không có bản dịch
    );
  };
